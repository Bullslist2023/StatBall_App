# app.py
"""
StatBall - Análise de Estatística Esportiva (v2.0)
Atualizações:
...
# ----------------------- Page config -----------------------
st.set_page_config(page_title="🖥️StatBall - Análise de Estatística Esportiva⚽",
                   page_icon="⚽",
                   layout="wide")
...
with colh1:
    st.title("🖥️StatBall — Análise de Estatística Esportiva⚽")
    st.markdown("**Distribuição de Poisson** • Probabilidades 0→10, P(X≥5) por evento, comparação entre times, interpretação automática (técnico + narrativo).")
with colh2:
